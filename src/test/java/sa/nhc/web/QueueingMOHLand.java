...
public class QueueingMOHLand extends NHCWebTest {

    /**
     * Prerequisite existing MOH land project / Active Queueing is disabled
     * The admin activate queueing feature
     * TC_01 to TC_12
     */

    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_01(Map<String, String> data) throws Exception {
    ...
    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_02(Map<String, String> data) throws Exception {
        logger.info("Step 00: Test Data : " + data.toString());
        app.openApplication(data);
        logger.info("Step 01: Navigate to Sakani admin site");
       //        app.loginPage.alertBoxLogin();
    ...
    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_03(Map<String, String> data) throws Exception {
        logger.info("Step 00: Test Data : " + data.toString());
        app.openApplication(data);
        logger.info("Step 01: Navigate to Sakani admin site");
       //        app.loginPage.alertBoxLogin();
    ...
    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_04(Map<String, String> data) throws Exception {
        logger.info("Step 00: Test Data : " + data.toString());
        app.openApplication(data);
        logger.info("Step 01: Navigate to Sakani admin site");
       //        app.loginPage.alertBoxLogin();
    ...
    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_05(Map<String, String> data) throws Exception {
        logger.info("Step 00: Test Data : " + data.toString());
        app.openApplication(data);
        logger.info("Step 01: Navigate to Sakani admin site");
       //        app.loginPage.alertBoxLogin();
    ...
    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_06(Map<String, String> data) throws Exception {
        logger.info("Step 00: Test Data : " + data.toString());
        app.openApplication(data);
        logger.info("Step 01: Navigate to Sakani admin site");
       //        app.loginPage.alertBoxLogin();
    ...
    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_07(Map<String, String> data) throws Exception {
        logger.info("Step 00: Test Data : " + data.toString());
        app.openApplication(data);
        logger.info("Step 01: Navigate to Sakani admin site");
       //        app.loginPage.alertBoxLogin();
    ...
    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_08(Map<String, String> data) throws Exception {
        logger.info("Step 00: Test Data : " + data.toString());
        app.openApplication(data);
        logger.info("Step 01: Navigate to Sakani admin site");
       //        app.loginPage.alertBoxLogin();
        ...
        CommonUtilityPage.verifyValueIsDisplayed("الحقل مطلوب", "This field is required", QueueingOffPlanPageObjects.InputFieldError1());
    }

    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_09(Map<String, String> data) throws Exception {
        logger.info("Step 00: Test Data : " + data.toString());
        app.openApplication(data);
        logger.info("Step 01: Navigate to Sakani admin site");
       //        app.loginPage.alertBoxLogin();
        ...
        CommonUtilityPage.verifyValueIsDisplayed("القيمة المدخلة غير صالحة، يرجى التحقق من المدخلات", "The value is invalid or wrong format", QueueingOffPlanPageObjects.InputFieldError1());
    }

    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_10(Map<String, String> data) throws Exception {
        logger.info("Step 00: Test Data : " + data.toString());
        app.openApplication(data);
        logger.info("Step 01: Navigate to Sakani admin site");
       //        app.loginPage.alertBoxLogin();
    ...
    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_11(Map<String, String> data) throws Exception {
        logger.info("Step 00: Test Data : " + data.toString());
        app.openApplication(data);
        logger.info("Step 01: Navigate to Sakani admin site");
       //        app.loginPage.alertBoxLogin();
        ...
        CommonUtilityPage.verifyValueIsDisplayed("القيمة المدخلة غير صالحة، يرجى التحقق من المدخلات", "The value is invalid or wrong format", QueueingOffPlanPageObjects.InputFieldError1());
        CommonUtilityPage.verifyValueIsDisplayed("القيمة المدخلة خاطئة. أقل قيمة ممكنة هي 1", "Minimum amount doesn't match", QueueingOffPlanPageObjects.InputFieldError2());
    }

    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_12(Map<String, String> data) throws Exception {
        logger.info("Step 00: Test Data : " + data.toString());
        app.openApplication(data);
        logger.info("Step 01: Navigate to Sakani admin site");
       //        app.loginPage.alertBoxLogin();
     ...
     */
    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_13(Map<String, String> data) throws Exception {
        logger.info("Step 00: Test Data : " + data.toString());
        app.openApplication(data);
    ...
    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_14(Map<String, String> data) throws Exception {
        logger.info("Step 00: Test Data : " + data.toString());
        app.openApplication(data);
        logger.info("Step 01: Navigate to Sakani housing site");
       //        app.loginPage.alertBoxLogin();
    ...
    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_15(Map<String, String> data) throws Exception {
        logger.info("Step 00: Test Data : " + data.toString());
        app.openApplication(data);
        logger.info("Step 01: Navigate to Sakani housing site");
       //        app.loginPage.alertBoxLogin();
    ...
    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_16(Map<String, String> data) throws Exception {
        logger.info("Step 00: Test Data : " + data.toString());
        app.openApplication(data);
        logger.info("Step 01: Navigate to Sakani housing site");
       //        app.loginPage.alertBoxLogin();
    ...
    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_17(Map<String, String> data) throws Exception {
        logger.info("Step 00: Test Data : " + data.toString());
        app.openApplication(data);
        logger.info("Step 01: Navigate to Sakani housing site");
       //        app.loginPage.alertBoxLogin();
    ...
    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_18(Map<String, String> data) throws Exception {
        logger.info("Step 00: Test Data : " + data.toString());
        app.openApplication(data);
        logger.info("Step 01: Navigate to Sakani housing site");
       //        app.loginPage.alertBoxLogin();
        ...
        logger.info("Step 06: Click on the searched project");
        app.mohLandBookingJourneyPage.clickOnTheSearchedProject();
        logger.info("Step 07: Verify the \"هناك حاليا 0 أشخاص في الطابور. \" message will display");
        CommonUtilityPage.verifyValueIsDisplayed("0", "0", QueueingOffPlanPageObjects.queueingMessage());
    }
    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_19(Map<String, String> data) throws Exception {
        logger.info("Step 00: Test Data : " + data.toString());
        app.openApplication(data);
        logger.info("Step 01: Navigate to Sakani housing site");
       //        app.loginPage.alertBoxLogin();
        ...
        logger.info("Step 06: Click on the searched project");
        app.mohLandBookingJourneyPage.clickOnTheSearchedProject();
        logger.info("Step 07: Click on join now button");
        app.queueingOffPlanPage.clickOnJoinNowButton();
        logger.info("Step 08: Verify the user navigate to the book details");
        app.queueingOffPlanPage.verifyBookingDetailsListIsDisplayed();
    }
    @Test(dataProvider = "testDataProvider")
    public void Queueing_MOH_Land_TC_20(Map<String, String> data) throws Exception {
        logger.info("Step 00: Test Data : " + data.toString());
        app.openApplication(data);
        logger.info("Step 01: Navigate to Sakani housing site");
       //        app.loginPage.alertBoxLogin();
       ...
       //        app.loginPage.alertBoxLogin();
        ...
        app.mohLandBookingJourneyPage.clickOnTheSearchedProject();
        app.queueingOffPlanPage.clickOnJoinNowButton();
        logger.info("Step 09: Verify the \"أنت 1 في الطابور!\" message will display");
